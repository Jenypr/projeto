...
- **Usuário (Criador de Conteúdo)**: responsável por gerenciar canais, vídeos e acompanhar métricas de desempenho no sistema YTTrack.

---

### 2.3 Lista de Casos de Uso Principais
...
## 2.4 Especificações Textuais dos Casos de Uso
...
**Fluxos Alternativos**:  
- 3a. Credenciais inválidas → o sistema exibe mensagem de erro e solicita nova tentativa.  
...
2. Usuário informa dados do canal (nome, URL e descrição).  
3. Sistema valida os dados informados.  
4. Sistema salva o canal no banco de dados.  

**Fluxos Alternativos**:  
- 3a. Dados incompletos ou inválidos → o sistema solicita correção.  
...
3. Usuário cadastra ou edita informações do vídeo (título, descrição e data de publicação).  
4. Sistema valida os dados informados.  
5. Sistema salva as alterações.  

**Fluxos Alternativos**:  
- 4a. Dados inválidos → o sistema solicita ajustes.  
...
**Fluxos Alternativos**:  
- 3a. Período sem dados → o sistema exibe mensagem informativa.  
